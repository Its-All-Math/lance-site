      ...
      <section id="home" className="relative overflow-hidden">
        <div className="max-w-6xl mx-auto px-4 py-20 md:py-28 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            >
              Pragmatic biotech, people & product development for your startup
            </motion.h1>
            <p className="mt-5 text-lg text-gray-600 max-w-xl">
              With 25 years in hard tech and a proven Swiss-army-knife skillset, I help early-stage teams turn ideas into execution, build high-performing teams, and align technology milestones with business goals.
            </p>
        ...
        <div className="max-w-6xl mx-auto px-4 py-16">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-gray-700">Project manage a development workstream, build light-weight data workflow into dashboards, support interview process for a key technical hire or develop technical roadmaps .</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader>
